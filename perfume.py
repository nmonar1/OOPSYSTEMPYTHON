...
class Perfume(ABC):
    ...
    @abstractmethod
    def get_info(self):
        # Abstract method to get information about the perfume
        pass
...
class VanillaPerfume(Perfume):
    ...
    def get_info(self):
        # Returns information about the vanilla perfume, shows polymorphism
...
class MuskyPerfume(Perfume):
    ...
    def get_info(self):
        # Returns information about the musky perfume, shows polymorphism
...
class FreshPerfume(Perfume):
    ...
    def get_info(self):
        # Returns information about the fresh perfume, shows polymorphism
